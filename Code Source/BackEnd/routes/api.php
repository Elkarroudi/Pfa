...
Route::prefix('v1')->group(function () {
    ...
    Route::middleware('notLoggedIn')->group(function () {
        ...
        Route::any('/auth/admin/', [RegistrationController::class, 'admin']);
    ...
    Route::middleware('isLoggedIn')->group(function () {
        ...
        Route::middleware('access:Admin')->group(function () {
            Route::any('company/all/', [CompanyController::class, 'index']);
            Route::any('company/create/', [CompanyController::class, 'create']);
            Route::any('company/update/{id}/', [CompanyController::class, 'update']);
