  ...
  <script>
    ...
    export default {
      name: "RecruiterDashLayout",
      setup() {
        let links = [
          { name: 'Applications', icon: 'company.png', },
          { name: 'Bookmark', icon: 'company.png', },
          { name: 'Educations', icon: 'company.png', },
          { name: 'Experiences', icon: 'company.png', },
